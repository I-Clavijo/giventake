	...
	return (
		<>
			...
			{chatData.map((chat, index) => (
				<div className={styles.chatContainer} key={index}>  {/*CHATCONTAINER IS PROFILE PIC, NAME AND LAST MESSAGE */}

					<span > {/* THE PROFILE PIC */}
						<img src="https://via.placeholder.com/50" alt="Profile" className={styles.profilePicture} />
					</span>

					<span className={styles.chatBox}> {/* THE CHATBOX PRESENT THE USER AND LAST MESSAGE */}
