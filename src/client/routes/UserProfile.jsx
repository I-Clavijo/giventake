...
const Profile = () => {
  ...
  const handleEditClick = () => {
    // Redirect to the edit page using your preferred method 
    console.log('Redirecting to edit page'); // Placeholder for now
  };

  return (
    <div className={styles.profileContainer}> 
      <button className={styles.editBtn} onClick={handleEditClick}>
      <a href="/editProfile" className={styles.editBtn}></a>
      </button>
...
<div class="flex justify-end px-4 pt-4">
    ...
    <div class="flex flex-col items-center pb-10">
        <img class="w-24 h-28 mb-3 rounded-full shadow-lg" src={profilePicture} alt="Bonnie image"/>
        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{user.name}</h5>
        <span class="text-sm text-gray-500 dark:text-gray-400">{user.location}</span>
